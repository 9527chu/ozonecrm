...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'crmapp.routing': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'installor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'installor'", 'blank': 'True', 'to': u"orm['crmapp.Maintainer']"}),
            'installtime': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
