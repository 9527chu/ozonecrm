...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Business.condition'
        db.delete_column(u'crmapp_business', 'condition')

        # Adding field 'Routing.condition'
        db.add_column(u'crmapp_routing', 'condition',
                      self.gf('django.db.models.fields.CharField')(default='not_installed', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Business.condition'
        db.add_column(u'crmapp_business', 'condition',
                      self.gf('django.db.models.fields.CharField')(default='not_installed', max_length=30),
                      keep_default=False)

        # Deleting field 'Routing.condition'
        db.delete_column(u'crmapp_routing', 'condition')
